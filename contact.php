...
<main class="main">
            ...
            <div class="row">
                <div class="col-auto">
                    <div class="align-container">
                        <div class="align-container__item"><span class="promo-primary__pre-title">Bengal Gearless Knights</span>
                            <h1 class="promo-primary__title"><span>Contact</span> <span>Us</span></h1>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="map-section">
        ...
        <div id="map" data-api-key="AIzaSyD5ES8GFHrarPhIVpDhFDea6fPtga0Wy4Y" data-longitude="-73.935242" data-latitude="40.730610" data-marker="img/placeholder.png"></div>
    </section>
    <!-- section end-->
</main>
